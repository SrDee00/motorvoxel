...
describe('VoxelWorld', () => {
    ...
    test('should generate chunks', async () => {
        ...
        const blockData = chunk.blocks;
        const hasNonAirBlocks = blockData.some((b) => b.id !== 0);
    ...
    test('should perform raycast', () => {
        ...
        voxelWorld.generateChunk(0, 0, 0).then(() => {
            ...
            const result = voxelWorld.findBlockRaycast([8, 100, 8], // Start above world
...
//# sourceMappingURL=VoxelWorld.test.js.map